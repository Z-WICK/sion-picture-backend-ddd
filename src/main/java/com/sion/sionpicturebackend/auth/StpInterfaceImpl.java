...
import static com.sion.sionpicture.domain.user.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        // 如果没有 spaceUserId，尝试通过 spaceId 或 pictureId 获取 Space对象
        Long spaceId = authContext.getSpaceId();
        if (spaceId == null) {
            // 如果 spaceId 为空，尝试通过 pictureId获取 Picture对象 和 Space对象
     ...
     * 从请求中获取上下文对象
     *
     * @return {@link SpaceUserAuthContext }
     */
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        if (ObjUtil.isNotNull(id)) {
            ...
            String parUrl = requestUrl.replace(contextPath + "/", "");
            String moduleName = StrUtil.subBefore(parUrl, "/", false);
            switch (moduleName) {
                case "picture":
